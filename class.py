...
class subfunctions:
  ...
  def displaymemberinfo(info):
    memberinf = csv.reader(info)
      row = []
      for rows in memberinf:
        row.append(rows)
  ...
  class Cultural(club , subfunctions):
    budget = 0
    ...
    def membersinfo():
      info = open('csv_files/cultural.csv')
    ...
    def fundsinfo():
      budget = 100000
      print("budget for 2022 = ",budget)
      
    
  class AaryaRaas(club , subfunctions):
    budget = 0
  ...
  class Abhijat(club , subfunctions):
    budget = 0
    ...
    def membersinfo():
         info = open('csv_files/Abhijaat.csv')
         displaymemberinfo(info)
  ...
  class ANC(club , subfunctions):
    ...
    def membersinfo():
      info = open('csv_files/Arts&Craft.csv')
      displaymemberinfo(info)
 ...
 class Astronomy(club , subfunctions):
    budget = 0
 ...
 class Mathematics(club , subfunctions):
    budget = 0
 ...
 class ScienceClub(club , subfunctions):
    budget = 0
 ...
 class Spandan(club , subfunctions):
    budget = 0  
    def clubinfo():
 ...
 class SpicMacay(club , subfunctions):
    budget = 0
 ...
 class Abhiyanta(club , subfunctions):
    budget = 0
...
class philomystics(club , subfunctions):
    budget = 0
...
class CoFSUG(club , subfunctions):
    budget = 0
...
class Debate_club(club , subfunctions):
    budget = 0
...
class HAM_club(club , subfunctions):
    budget = 0
...
class History(club , subfunctions):
    budget = 0
...
class Janeev(club , subfunctions):
    budget = 0
    def clubinfo():
...
class Boat Club(club , subfunctions):
    budget = 0
...
class Consulting Club(club , subfunctions):
    budget = 0
 ...
 class BhauECell(club , subfunctions):
    budget = 0
